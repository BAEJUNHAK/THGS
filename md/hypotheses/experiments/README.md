...
| **6 (=P1)** | **기존 paper 들의 문제점 구체화 및 확정** — 경쟁 처방은 왜 실패하나 (A) / score 함수가 '없음' 을 아나 (B) / phantom 방향이 systematic 한가 (C) / hierarchy 가 phantom 을 증폭하나 (D) | **[../strategy/roadmap.md](../strategy/roadmap.md)** P1: A 부검 CA-1/2 (R11, [../strategy/competitor_autopsy.md](../strategy/competitor_autopsy.md)) + B 부재쿼리 (R13) + C E1 + D E2 ([../strategy/p1_problem_experiments.md](../strategy/p1_problem_experiments.md)) + E VALA·StS 코드 실험 (future) | ⏳ **실행 대기** | P2 (method: 가드 R12 + R10 + 이식) 는 P1 리뷰 후 |
